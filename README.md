...
```sh
git clone https://github.com/c1/nomad-test-parser.git
cd nomad-test-parser
...
| Name | E-mail     |
|------|------------|
| Michele Ciaffarafà | [michele.ciaffarafa@gmail.com](mailto:michele.ciaffarafa@gmail.com)
